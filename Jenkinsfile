pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://18.215.252.255:9090/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git url: 'https://github.com/Mrjack1525/fullstackapp.git', branch: 'master'
            }
        }
    ...
    post {
        success {
            echo "✅ Backend deployed: http://18.215.252.255:9090/springapp1"
            echo "✅ Frontend deployed: http://18.215.252.255:9090/frontapp1"
        }
        failure {
