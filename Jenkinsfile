pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://54.159.149.132:9090/manager/html'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    post {
        success {
            echo "✅ Backend deployed: http://http://54.159.149.132/:9090/springapp1"
            echo "✅ Frontend deployed: http://http://54.159.149.132/:9090/frontapp1"
        }
        failure {
